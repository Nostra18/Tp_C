...
void menuInvite (){
    ...
    esp();cout<<"       Que voulez-vous faire ?"<<endl<<endl;
    esp();cout<<"1.       S'enregistrer "<<endl; esp();cout<<"2.       S'enregistrer a une fete"<<endl;
...
int main()
{
    //DECLARATION
    menu();
    cout<<endl<<endl<<"MERCI ET AUREVOIR !!!"<<endl;
    return 0;
}
