...
// FONCTION QUI RETOURNE UN VECTEUR DES NOMBRES PREMIERS COMPRIS ENTRE 0 et NOMBRES DES PLACES
...
// METHODE QUI ENREGISTRE UNE FETE
void Party:: save (){
...
// FONCTION QUI RETOURNE LE NOMBRE D'INVITE ENREGISTRE POUR LA FETE
int Party:: nbreInvit (){
    int compteur=0;
    for (int i; i<25; i++){
...
// FONCTION POUR AFFICHER UNE FETE
void Party:: afficher() {
...
// FONCTION QUI ENREGISTRE UN INVITE DANS UNE FETE
